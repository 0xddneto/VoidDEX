...
export default function VoidDex({initialStates}:{initialStates:DexPoolState[]}){
 ...
 return <main className="shell">
  ...
  <footer className="foot"><span>Factory {DEX.factory.slice(0, 6)}…{DEX.factory.slice(-4)}</span><span>Runtime {RUNTIME}</span><a href="https://voidscan-nu.vercel.app">Open VoidScan →</a></footer>
 </main>;
}

...
export default async function Page() {
  try {
    ...
    return <main className="shell"><h1>VoidDEX</h1><p>Pool data is temporarily unavailable. Please reload shortly.</p><a href="https://voidscan.voidshub.com">Open VoidScan</a></main>;
  }
}

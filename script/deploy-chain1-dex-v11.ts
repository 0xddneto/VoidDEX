...
const corePath = resolve(root, process.env.V11_CORE_RECORD_FILE ?? '../VoidChainApp/script/deployments/testnet-v11-clean.json');
const configPath = resolve(root, process.env.V11_DEX_CONFIG_FILE ?? 'lib/deployment-v11-clean.json');
